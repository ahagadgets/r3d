...
# for the 5M thermistor, use 560K as R2, and use this command:
# python createTemperatureLookup.py --t0=25 --r0=5000000 --beta=4261 --r2=560000 --r1=0
...
#   adcs = [1, 20, 25, 30, 35, 40, 45, 50, 60, 70, 80, 90, 100, 110, 130, 150, 190, 220,  250, 300]
    ...
    for adc in adcs:
        counter = counter +1
        if counter == len(adcs):
            print "   {%s, %s}" % (1024-adc, int(t.temp(adc)))
        else:
            print "   {%s, %s}," % (1024-adc, int(t.temp(adc)))
    print "};"
